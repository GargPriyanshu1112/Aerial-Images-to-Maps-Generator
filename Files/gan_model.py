...
def define_gan(inp_shape):
    ...
    # Instantiate the model with source image as input; discriminator output (0 or 1)
    # and fake image generated by the generator as outputs
    gan_model = Model(inputs=src_img, outputs=[dis_output, gen_img])
